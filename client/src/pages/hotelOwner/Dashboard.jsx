      ...
      <div className='flex gap-4 my-8'> 
        ...
        {/* --Total Bookings-- */} 
          ...
          pr-8'> 
            ...
            <div className='flex flex-col sm:ml-4 font-medium'> 
              <p className='text-blue-500 text-1g'>Total Bookings</p> 
        ...
        {/* --Total Revenue-- */} 
          ...
          pr-8'> 
            ...
            h-10'/> 
            <div className='flex flex-col sm:ml-4 font-medium'> 
              <p className='text-blue-500 text-1g'>Total Revenue</p> 
              <p className='text-neutral-400 text-base'>$ {dashboardData. 
              totalRevenue}</p>  
            </div> 
          </div>
            ...
            {dashboardData.bookings.map((item, index)=>( 
              <tr key={index}> 
                ...
                <td className='py-3 px-4 border-t border-gray-300 flex'>
                    <button className={`py-1 px-3 text-xs rounded-full mx-auto ${item.isPaid ? 'bg-green-200 text-green-600' : 'bg-amber-200 text-yellow-600'}`}>{item.isPaid ? 'Completed' : 'Pending'}
                    </button>
                </td>
